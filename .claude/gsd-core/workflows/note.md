...
- **Global scope**: `C:/Users/Samit/Desktop/Work/SDD/SDD1/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Samit/Desktop/Work/SDD/SDD1/.claude/notes/`)
...
2. Glob `C:/Users/Samit/Desktop/Work/SDD/SDD1/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Samit/Desktop/Work/SDD/SDD1/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Samit/Desktop/Work/SDD/SDD1/.claude/notes/` — works in any directory

...
```
Agent(
  prompt="Read C:/Users/Samit/Desktop/Work/SDD/SDD1/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Samit/Desktop/Work/SDD/SDD1/.claude/gsd-core/templates/SECURITY.md`
